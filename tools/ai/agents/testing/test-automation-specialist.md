...
description: Write new tests, run existing tests, analyze failures, and fix them while maintaining test integrity. Use PROACTIVELY after code modifications to ensure comprehensive test coverage and suite health. MUST BE USED after implementing features, refactoring, or fixing bugs.
color: lime
---
