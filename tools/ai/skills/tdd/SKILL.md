...
- For test examples (good vs bad), see [tests.md](tests.md)
- For mocking guidelines, see [mocking.md](mocking.md)
- For refactoring patterns, see [refactoring.md](refactoring.md)
- For deep module design, see [deep-modules.md](deep-modules.md)
- For interface design principles, see [interface-design.md](interface-design.md)
